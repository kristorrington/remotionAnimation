      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 44 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 30 }}>
          ...
          <div style={{ position: "relative", opacity: brainOp, marginLeft: 24 }}>
            <div style={{ width: 190, height: 190, borderRadius: 26, border: "4px solid #C15F3C", background: "rgba(12,18,30,0.9)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 30px rgba(193,95,60,0.3)" }}>
              <IconBrain size={130} />
            </div>
