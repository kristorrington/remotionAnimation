...
export const SFX = {
  ...
  // Model-review edit kit (2026-07, generated by scripts/gen-sfx.mjs — restrained,
  // royalty-free, deterministic; keep the palette calm, no cinematic booms):
  softWhoosh: staticFile("audio/sfx/soft-whoosh.wav"), // text entrances / card animations
  interfaceClick: staticFile("audio/sfx/interface-click.wav"), // small confirms / chips
  lowImpact: staticFile("audio/sfx/low-impact.wav"), // card lands / section start (soft thump)
  shortRiser: staticFile("audio/sfx/short-riser.wav"), // into the main hook question
  transitionSweep: staticFile("audio/sfx/transition-sweep.wav"), // major section transition
  confirmation: staticFile("audio/sfx/confirmation.wav"), // benchmark reveal / positive payoff
  warningPulse: staticFile("audio/sfx/warning-pulse.wav"), // caveat / safety accent
} as const;
