...
export const ARCHIVED_SHORTS: ShortSpec[] = [
  // ==========================================================================
  // Gemini Robotics 2 shorts (talking-head-030826.mp4) - archived 2026-08-09.
  // Still posting Aug 8-12 from rendered mp4s; specs parked here.
  // ==========================================================================
  {
    ...
    beats: [
      { at: 8, scene: "clip", tint: "#6E93BD", text: "THE DEMO", clip: { src: "assets/external/clips/rob2-lightbulb.mp4" } }, // "the lightbulb task is the most interesting" (band)
      { at: 236, scene: "clip", tint: "#6E93BD", text: "GRIP · TURN · RELEASE", clip: { src: "assets/external/clips/rob2-lightbulb.mp4" } }, // "grip round & fragile… reposition as it turns" (band)
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "clip", tint: "#6E93BD", text: "THE CLAIM", clip: { src: "assets/external/clips/rob2-extra-wholebody.mp4" } }, // "one unified AI system controls the entire body" (band)
      { at: 236, scene: "clip", tint: "#6E93BD", text: "ARMS · HANDS · BALANCE", clip: { src: "assets/external/clips/rob2-extra-wholebody.mp4" } }, // "the arms, the hands, the movements, the balance" (band)
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "clip", tint: "#4FA98A", text: "THE GARAGE", clip: { src: "assets/external/clips/rob2-garage.mp4" } }, // "two robots operating in the same garage" (band)
      { at: 236, scene: "clip", tint: "#4FA98A", text: "SAME SPACE, SAME TIME", clip: { src: "assets/external/clips/rob2-garage.mp4" } }, // "Apollo and Duo tidy and place tools at the same time" (band)
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "clip", tint: "#C65B52", text: "THE HIGHLIGHT REEL", clip: { src: "assets/external/clips/rob2-extra-sixgrid.mp4" } }, // "Google hasn't published success rates" (band)
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "clip", tint: "#4FA98A", text: "THE VERDICT", clip: { src: "assets/external/clips/rob2-hero.mp4" } }, // "so is it actually a breakthrough?" (band)
      { at: 236, scene: "clip", tint: "#4FA98A", text: "YES — NOT THE REEL", clip: { src: "assets/external/clips/rob2-extra-wholebody.mp4" } }, // "the answer is yes, but not for the reason the reel suggests" (band)
  ...
  // ==========================================================================
  // AI-news DeepSeek/OpenAI/Qwen roundup (talking-head-020826.mp4) - archived
  // 2026-08-03. Still posting Aug 3-7 from rendered mp4s; specs parked here.
  // ==========================================================================
  {
    ...
    beats: [
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "the receipt", shot: { src: "assets/external/screenshots/ai2-ds-pricing.png", url: "api-docs.deepseek.com/quick_start/pricing", imageW: 1560, imageH: 1800, from: { x: 0, y: 0, w: 1560, h: 1400 }, to: { x: 0, y: 0, w: 1560, h: 1800 }, zoomAt: 0 } },
      { at: 269, scene: "coins", tint: "#4FA98A", text: "SAME FIX", stamp: "~200× CHEAPER" },
      { at: 556, scene: "emote", pose: "worried", tint: "#C9913D", text: "NOT PROVEN YET" },
      { at: 800, scene: "stamp", verdict: "warn", badge: "API ONLY", tint: "#6E93BD", text: "STILL EARLY" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "receipt", tint: "#4FA98A", text: "official", shot: { src: "assets/external/screenshots/ai2-altman.png", url: "x.com/sama", imageW: 1100, imageH: 1330, from: { x: 0, y: 0, w: 1100, h: 1000 }, to: { x: 0, y: 0, w: 1100, h: 1330 }, zoomAt: 0 } },
      { at: 216, scene: "coins", tint: "#4FA98A", text: "CHEAPEST TIER", stamp: "−80%" },
      { at: 470, scene: "emote", pose: "alarmed", tint: "#C9913D", text: "UNDERCUTTING RIVALS" },
      { at: 800, scene: "stamp", verdict: "cross", badge: "RACE TO $0", tint: "#C65B52", text: "IT'S ON" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "emote", pose: "confused", tint: "#C9913D", text: "SMELLS OFF" },
      { at: 216, scene: "reject", badge: "$120 / M", tint: "#C65B52", text: "DOESN'T ADD UP" },
      { at: 568, scene: "receipt", tint: "#4FA98A", text: "the real price", shot: { src: "assets/external/screenshots/ai2-openai-luna.png", url: "developers.openai.com/api/docs/models/gpt-5.6-luna", imageW: 2010, imageH: 800, from: { x: 0, y: 0, w: 2010, h: 800 }, to: { x: 0, y: 0, w: 2010, h: 800 }, zoomAt: 0 } },
      { at: 700, scene: "stamp", verdict: "cross", badge: "IT'S A TYPO", tint: "#C65B52", text: "IT'S $1.20" },
    ],
    fullscreen: [{ from: 203, to: 403 }],
    outro: "FOLLOW FOR FACT-CHECKED AI NEWS",
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "emote", pose: "alarmed", tint: "#C65B52", text: "A SECRET NAME" },
      { at: 216, scene: "stamp", verdict: "cross", badge: "MEW3", tint: "#C65B52", text: "THEN DELETED" },
      { at: 560, scene: "emote", pose: "shrug", tint: "#C9913D", text: "ALREADY 'GPT-6'?" },
      { at: 820, scene: "stamp", verdict: "warn", badge: "UNCONFIRMED", tint: "#6E93BD", text: "NOT A LAUNCH" },
    ],
    fullscreen: [{ from: 203, to: 403 }],
    outro: "FOLLOW FOR MORE",
    music: "music/tension.MP3",
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "emote", pose: "pointing", tint: "#D97757", text: "THREE LEVELS" },
      { at: 216, scene: "check", obj: "shield", verdict: "check", tint: "#4FA98A", text: "1 · STATE IT" },
      { at: 560, scene: "check", obj: "gauge", verdict: "warn", tint: "#C9913D", text: "2 · CITE IT" },
      { at: 900, scene: "stamp", verdict: "cross", badge: "UNVERIFIED", tint: "#C65B52", text: "3 · IGNORE IT" },
    ],
    fullscreen: [{ from: 203, to: 403 }],
    outro: "FOLLOW FOR THE WEEKLY BREAKDOWN",
    music: "music/calm.MP3",
  ...
  // ==========================================================================
  // AI-news-this-week video (talking-head.mp4) - archived 2026-08-02.
  // ==========================================================================
  {
    ...
    beats: [
      { at: 8, scene: "receipt", tint: "#C65B52", text: "the disclosure", shot: { src: "assets/external/screenshots/ainews-delangue-hf.png", url: "x.com/ClementDelangue", imageW: 1100, imageH: 1440, from: { x: 0, y: 0, w: 1100, h: 1000 }, to: { x: 0, y: 0, w: 1100, h: 1440 }, zoomAt: 0 } },
      { at: 245, scene: "emote", pose: "alarmed", tint: "#C9913D", text: "NO GUARDRAILS ON" },
      { at: 573, scene: "stamp", verdict: "cross", badge: "IT CHAINED THE HOLES", tint: "#C65B52", text: "STRAIGHT INTO A BREACH" },
      { at: 880, scene: "check", obj: "shield", verdict: "warn", tint: "#6E93BD", text: "LOCK EGRESS + SCOPE" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "emote", pose: "thinking", tint: "#6E93BD", text: "THE STICKER PRICE LIES" },
      { at: 216, scene: "queue", labels: ["RETRIES", "EXTRA TOOL CALLS", "STALLED RUNS"], tint: "#C9913D", text: "WHAT REALLY BILLS YOU" },
      { at: 477, scene: "receipt", tint: "#D97757", text: "scored on whole tasks", shot: { src: "assets/external/screenshots/ainews-opus5-effort.png", url: "anthropic.com/news/claude-opus-5", imageW: 3840, imageH: 1150, from: { x: 0, y: 0, w: 3840, h: 1150 }, to: { x: 0, y: 0, w: 3840, h: 1150 }, zoomAt: 0 } },
      { at: 763, scene: "check", obj: "gauge", verdict: "check", tint: "#4FA98A", text: "JUDGE COMPLETION COST" },
    ],
    fullscreen: [{ from: 203, to: 403 }],
    outro: "FOLLOW FOR MORE",
    music: "music/tension.MP3",
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "the backing", shot: { src: "assets/external/screenshots/ainews-jensen.png", url: "x.com/JensenHuang", imageW: 1100, imageH: 1300, from: { x: 0, y: 0, w: 1100, h: 900 }, to: { x: 0, y: 0, w: 1100, h: 1300 }, zoomAt: 0 } },
      { at: 315, scene: "emote", pose: "pointing", tint: "#4FA98A", text: "MORE SUPPLIERS = LEVERAGE" },
      { at: 563, scene: "doors", labels: ["ROUTINE", "MID", "HARD"], value: 0, tint: "#D97757", text: "ROUTE TASK TO ITS FIT" },
      { at: 880, scene: "stamp", verdict: "check", badge: "PORTABLE BY DESIGN", tint: "#4FA98A", text: "DON'T LOCK IN" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 31, scene: "emote", pose: "pointing", tint: "#D97757", text: "THE ONLY TEST" },
      { at: 203, scene: "doors", labels: ["CAPABILITY", "RISK", "COST"], value: 1, tint: "#6E93BD", text: "DID IT CHANGE THESE?" },
      { at: 430, scene: "check", obj: "clock", verdict: "warn", tint: "#C9913D", text: "TODAY, NOT SOMEDAY" },
      { at: 650, scene: "stamp", verdict: "check", badge: "RUN THE FILTER", tint: "#4FA98A", text: "ON EVERY DROP" },
    ],
  ...
  // ==========================================================================
  // The-5-habits video (talking-head-habits-260726.mp4) - archived 2026-07-27.
  // ==========================================================================
  {
    id: "Short-VagueBrief",
    label: "THE HOOK: managing agents like interns you brief once and abandon",
    source: "talking-head-habits-260726.mp4",
    from: 0,
    durationInFrames: 900,
    ...
    beats: [
      { at: 8, scene: "emote", pose: "pointing", tint: "#C9913D", text: "ONE VAGUE SENTENCE" },
      { at: 191, scene: "stamp", verdict: "cross", badge: "THE INTERNS", tint: "#C65B52", text: "GET THE BLAME" },
      { at: 500, scene: "reject", badge: "SMARTER MODEL", tint: "#C65B52", text: "WON'T FIX IT" },
      { at: 748, scene: "check", obj: "brain", verdict: "check", tint: "#4FA98A", text: "MANAGE, DON'T SWAP" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 217, scene: "queue", labels: ["DELETE DUPES?", "FIX FORMATS?", "REBUILD IT?"], tint: "#C9913D", text: "ONE WORD, FOUR JOBS" },
      { at: 682, scene: "emote", pose: "confused", tint: "#C9913D", text: "NO BUSINESS CONTEXT" },
      { at: 950, scene: "check", obj: "gauge", verdict: "warn", tint: "#6E93BD", text: "OUTCOME · LIMITS · PROOF" },
      { at: 1060, scene: "stamp", verdict: "check", badge: "A REAL BRIEF", tint: "#4FA98A", text: "FAR LESS GUESSING" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 85, scene: "emote", pose: "thinking", tint: "#6E93BD", text: "IT SOUNDS RIGHT" },
      { at: 355, scene: "stamp", verdict: "cross", badge: "WRONG ROW", tint: "#C65B52", text: "CHECK ONE DETAIL" },
      { at: 700, scene: "check", obj: "brain", verdict: "warn", tint: "#C9913D", text: "'ARE YOU SURE?' FAILS" },
      { at: 950, scene: "check", obj: "shield", verdict: "check", tint: "#4FA98A", text: "ASK FOR THE SOURCE" },
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 126, scene: "emote", pose: "pointing", tint: "#D97757", text: "ONE WIN ISN'T PROOF" },
      { at: 400, scene: "check", obj: "gauge", verdict: "warn", tint: "#6E93BD", text: "REPEATED · TRACED · EARNED" },
      { at: 604, scene: "doors", labels: ["SUPERVISED", "FEWER CHECKS", "AUTONOMOUS"], value: 0, tint: "#D97757", text: "MOVE UP ON PROOF" },
      { at: 900, scene: "stamp", verdict: "check", badge: "EARN IT FIRST", tint: "#D97757", text: "THEN EXPAND" },
    ],
  ...
  // Claude Opus 5 video (talking-head.mp4, 2026-07-26).
  {
    ...
    beats: [
      ...
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "independently tested", shot: { src: "assets/external/screenshots/opus5-aa-top.png", url: "artificialanalysis.ai", imageW: 3840, imageH: 1600, from: { x: 300, y: 300, w: 1500, h: 920 }, to: { x: 300, y: 300, w: 1500, h: 920 }, zoomAt: 0, highlight: { x: 500, y: 330, w: 520, h: 520 }, highlightAt: 44 } }, // "#1 on its Intelligence Index" (8-230)
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 8, scene: "receipt", tint: "#C65B52", text: "the eval receipt", shot: { src: "assets/external/screenshots/opus5-aa-top.png", url: "artificialanalysis.ai", imageW: 3840, imageH: 1600, from: { x: 440, y: 900, w: 2100, h: 640 }, to: { x: 440, y: 900, w: 2100, h: 640 }, zoomAt: 0, highlight: { x: 490, y: 1225, w: 1970, h: 120 }, highlightAt: 44 } }, // "100 million output tokens" (9046)
  ...
  // ==========================================================================
  // OpenAI-rogue-agent video (talking-head-240726.mp4) - archived 2026-07-26.
  // ==========================================================================
  // OpenAI-rogue-agent video (talking-head.mp4, 2026-07-24).
  {
    ...
    source: "talking-head-240726.mp4",
  ...
  // ==========================================================================
  // Qwen-3.8-Max video (talking-head-220726.mp4) - archived 2026-07-24.
  // ==========================================================================
  // ==========================================================================
  ...
  // ==========================================================================
  {
    ...
    source: "talking-head-220726.mp4",
  ...
  // ==========================================================================
  // Fable-5-permanent video (talking-head-210726.mp4) - archived 2026-07-22.
  // ==========================================================================
  // ==========================================================================
  ...
  // ==========================================================================
  {
    ...
    source: "talking-head-210726.mp4",
  ...
  // ==========================================================================
  // Kimi K3 video (talking-head-180726.mp4) - archived 2026-07-19.
  // ==========================================================================
  // ==========================================================================
  ...
  // ==========================================================================
  {
    ...
    source: "talking-head-180726.mp4",
  ...
  // ==========================================================================
  // 7 GitHub repos video (talking-head-170726.mp4) - archived 2026-07-18.
  // ==========================================================================
  // ==========================================================================
  ...
  // ==========================================================================
  {
    ...
    source: "talking-head-170726.mp4",
  ...
  // ==========================================================================
  // Claude-skills ranking video (talking-head-160726.mp4) - archived 2026-07-17.
  // ==========================================================================
  {
    id: "Short-Superpowers",
    label: "THE HOOK: the #1 pick — Superpowers stops Claude jumping into the build",
    source: "talking-head-160726.mp4",
    ...
    beats: [
      ...
      { at: 331, scene: "bolt", tint: "#6E93BD", text: "THINK FIRST" }, // "an operating system for Claude" (7295-7334)
      { at: 450, scene: "stamp", verdict: "cross", badge: "BUILD NOW", tint: "#C65B52", text: "PUMP THE BRAKES" }, // "stopping Claude from jumping straight into the build" (7414-7514); span.from+13
      { at: 612, scene: "check", obj: "gauge", verdict: "warn", tint: "#C9913D", text: "DEMO ≠ DELIVERY" }, // "looks impressive early but creates more work later" (7576-7688)
    ],
  ...
  },
  {
    ...
    beats: [
      { at: 8, scene: "emote", pose: "confused", tint: "#C9913D", text: "SOUND FAMILIAR?" }, // "completes part of a task" (2322-2400)
      { at: 130, scene: "stamp", verdict: "check", badge: "80% DONE", tint: "#C65B52", text: "DECLARES VICTORY" }, // "confidently says the job is finished" (2434-2510)
      // EVIDENCE: Matthew Berman's own launch tweet, on the claim it fixes
      { at: 323, scene: "receipt", tint: "#4FA98A", text: "THE RECEIPT", shot: { src: "assets/external/screenshots/berman-loop-tweet.png", url: "x.com/MatthewBerman", imageW: 1100, imageH: 1058, from: { x: 20, y: 10, w: 1060, h: 530 }, to: { x: 10, y: 5, w: 1080, h: 640 }, zoomAt: 8 } }, // "Loop Library gives you reusable prompts" (2635-2712); holds ~3.6s
      { at: 445, scene: "retry", tint: "#6E93BD", text: "RUN IT AGAIN" }, // "keep Claude working until… finish condition" (2718-2830); span.from+13
      { at: 579, scene: "check", obj: "shield", verdict: "check", tint: "#4FA98A", text: "GREEN OR NOTHING" }, // "every test passes… checklist completed" (2903-2985)
      { at: 706, scene: "emote", pose: "shrug", tint: "#C65B52", text: "GOOD ENOUGH ≠ DONE" }, // "stops when the answer looks acceptable" (3030-3092)
    ],
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 110, scene: "receipt", tint: "#4FA98A", text: "THE RECEIPT", shot: { src: "assets/external/screenshots/taste-site-wide.png", url: "tasteskill.dev", imageW: 2800, imageH: 1497, from: { x: 180, y: 380, w: 900, h: 450 }, to: { x: 140, y: 80, w: 1300, h: 650 }, zoomAt: 8 } }, // "the generic look seen across many AI interfaces" (5616-5710); holds ~6.5s
      { at: 306, scene: "conveyor", labels: ["SAME UI AGAIN"], tint: "#C65B52", text: "SPOT THE DIFFERENCE" }, // "the same gradients, the same oversized heading" (5760-5804)
      { at: 470, scene: "check", obj: "gauge", verdict: "warn", tint: "#C9913D", text: "RUNS FINE. LOOKS OFF." }, // "working doesn't mean it's always well designed" (5915-5972); span.from+13
      { at: 690, scene: "testbench", tint: "#6E93BD", text: "RUN IT TWICE" }, // "give Claude the same design brief and test it with and without Taste" (6194-6320)
    ],
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 250, scene: "doors", labels: ["SUPER", "TASTE", "PX", "LOOP", "REACH"], tint: "#6E93BD", text: "THE LEADERBOARD" }, // "PX Pipe (8948)… Loop Library (9040)… Agent Reach (9116)"
  ...
  // ==========================================================================
  // Astra ten-proofs shorts (talking-head-090826.mp4) - archived 2026-08-16.
  // Posting Aug 16-20 from rendered mp4s; specs parked here.
  // ==========================================================================
  ...
  },
  {
    ...
    faceX: 51,
    beats: [
      { at: 8, scene: "clip", tint: "#4FA98A", text: "MACHINE-CHECKED", clip: { src: "assets/external/clips/astra-stock-code.mp4" } }, // "machine-checked in Lean 4" (band)
  ...
  },
  {
    ...
    faceX: 51,
    beats: [
      { at: 8, scene: "receipt", tint: "#4FA98A", text: "may 20 — the real one", shot: { src: "assets/external/screenshots/astra-may-erdos-wide.png", url: "openai.com/index/model-disproves-discrete-geometry-conjecture", imageW: 3840, imageH: 2052, from: { x: 1011, y: 287, w: 1822, h: 974 }, to: { x: 154, y: 82, w: 3532, h: 1888 }, zoomAt: 8 } }, // "the real 80-year result, May 20"
  ...
  },
  {
    ...
    faceX: 51,
    beats: [
      { at: 8, scene: "receipt", tint: "#4FA98A", text: "public & checkable", shot: { src: "assets/external/screenshots/astra-tweet-noam.png", url: "x.com/polynoamial", imageW: 1100, imageH: 1490, from: { x: 20, y: 60, w: 1060, h: 1000 }, to: { x: 0, y: 0, w: 1100, h: 1490 }, zoomAt: 8 } }, // "recheck on your own laptop"
  ...
  },
  {
    ...
    faceX: 51,
    beats: [
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "still undecided", shot: { src: "assets/external/screenshots/astra-tweet-testingcatalog.png", url: "x.com/testingcatalog", imageW: 1100, imageH: 1550, from: { x: 25, y: 100, w: 1050, h: 900 }, to: { x: 0, y: 0, w: 1100, h: 1550 }, zoomAt: 8 } }, // "code name vs the model that shipped"
  ...
  // ==========================================================================
  // Graph Engineering shorts (talking-head-160826.mp4) - archived 2026-08-20.
  // Posting Aug 21-25 from rendered mp4s; specs parked here.
  // ==========================================================================

  {
    ...
    faceX: 49,
    beats: [
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "langchain's own blog", shot: { src: "assets/external/screenshots/ge-langchain-blog-wide.png", url: "langchain.com/blog", imageW: 1884, imageH: 1007, from: { x: 110, y: 340, w: 1330, h: 710 }, to: { x: 0, y: 0, w: 1884, h: 1007 }, zoomAt: 8 } }, // "3 Years of Graph Engineering with LangGraph"
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 599, scene: "receipt", tint: "#6E93BD", text: "the debunk", shot: { src: "assets/external/screenshots/ge-turingpost.png", url: "turingpost.com", imageW: 1796, imageH: 960, from: { x: 40, y: 0, w: 1520, h: 810 }, to: { x: 0, y: 0, w: 1796, h: 960 }, zoomAt: 8, highlight: { x: 50, y: 8, w: 1450, h: 180 }, highlightAt: 100 } }, // "Turing Post actually checked the claim" (7957)
  ...
  },
  {
    ...
    faceX: 49,
    beats: [
      { at: 8, scene: "clip", tint: "#6E93BD", text: "ONE AGENT. ONE RUN.", clip: { src: "assets/external/clips/ge-langgraph-a.mp4" } }, // LangChain's own node-graph film (band)
  ...
  },
  {
    ...
    faceX: 49,
    beats: [
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "jul 4 — nobody noticed", shot: { src: "assets/external/screenshots/ge-josh-simmons.png", url: "drjoshcsimmons.com", imageW: 1446, imageH: 773, from: { x: 50, y: 300, w: 1340, h: 470 }, to: { x: 0, y: 0, w: 1446, h: 773 }, zoomAt: 8 } }, // "Josh Simmons used the phrase in a blog post" (5573)
      ...
      { at: 560, scene: "receipt", tint: "#C65B52", text: "jul 18 — it catches fire", shot: { src: "assets/external/screenshots/ge-tweet-steipete.png", url: "x.com/steipete", imageW: 1100, imageH: 450, from: { x: 60, y: 20, w: 980, h: 401 }, to: { x: 0, y: 0, w: 1100, h: 450 }, zoomAt: 8, highlight: { x: 70, y: 145, w: 960, h: 95 }, highlightAt: 140 } }, // "Steinberger posted a question… loops or graphs" (6054)
    ],
  ...
  },
  {
    ...
    faceX: 49,
    beats: [
      { at: 8, scene: "receipt", tint: "#6E93BD", text: "what 'shipped' looks like", shot: { src: "assets/external/screenshots/ge-adk.png", url: "developers.googleblog.com", imageW: 2300, imageH: 1229, from: { x: 170, y: 300, w: 1560, h: 260 }, to: { x: 90, y: 20, w: 2120, h: 1060 }, zoomAt: 8 } }, // official docs = the bar (Google ADK blog)
