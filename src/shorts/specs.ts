...
export const SHORTS: ShortSpec[] = [
  ...
  // ==========================================================================
  {
    ...
    // SCENE 1 = the OFFICIAL reveal montage, full-screen from the top (animHook)
    animHook: true,
    beats: [
      // OFFICIAL FILM montage OPENS the short, full-screen (scene 1)
      { at: 4, scene: "clip", tint: "#D97757", text: "the reveal", clip: { src: "assets/external/clips/kimi-open-montage.mp4" } }, // "Moonshot AI just revealed the world's most powerful open model" (1-141)
      // EVIDENCE: the arena table — K3 #1, Claude + GPT right below
      { at: 230, scene: "receipt", tint: "#4FA98A", text: "the arena table", shot: { src: "assets/external/screenshots/arena-webdev-top-wide.png", url: "arena.ai/leaderboard/code/webdev", imageW: 2820, imageH: 1507, from: { x: 40, y: 380, w: 2740, h: 1096 }, to: { x: 40, y: 300, w: 2740, h: 800 }, zoomAt: 8, highlight: { x: 46, y: 494, w: 2720, h: 108 }, highlightAt: 80 } }, // "number one spot in front-end coding" (194-282)
    ...
    // full-anim: the reveal montage OPENS the short (animHook) + the catches trio
    fullscreen: [{ from: 108, to: 190 }, { from: 540, to: 890 }],
  ...
  },
  {
    ...
    beats: [
      // OFFICIAL FILM montage OPENS the short, full-screen (scene 1)
      { at: 4, scene: "clip", tint: "#4FA98A", text: "the reveal", clip: { src: "assets/external/clips/kimi-open-montage.mp4" } }, // "Vals AI independently tested Kimi K3" (1036-1126)
      // EVIDENCE: the evaluation card with the 74.70% / #2-of-38 claim
      { at: 230, scene: "receipt", tint: "#4FA98A", text: "the vals card", shot: { src: "assets/external/screenshots/vals-kimi-card-wide.png", url: "vals.ai", imageW: 2900, imageH: 1550, from: { x: 100, y: 100, w: 1400, h: 748 }, to: { x: 40, y: 40, w: 2820, h: 1507 }, zoomAt: 8, highlight: { x: 120, y: 300, w: 760, h: 180 }, highlightAt: 120 } }, // "scored 74.7%, placing second of 38" (1244-1452)
    ...
    // full-anim: the reveal montage OPENS the short (animHook)
    fullscreen: [{ from: 108, to: 190 }],
  ...
  },
  {
    ...
    beats: [
      // OFFICIAL FILM montage OPENS the short, full-screen (scene 1)
      { at: 4, scene: "clip", tint: "#6E93BD", text: "the reveal", clip: { src: "assets/external/clips/kimi-open-montage.mp4" } }, // "slower output is only half the problem" (7409-7477)
      // EVIDENCE: the AA verbosity tile
      { at: 230, scene: "receipt", tint: "#C65B52", text: "the 130M tile", shot: { src: "assets/external/screenshots/aa-kimi-tokens.png", url: "artificialanalysis.ai/models/kimi-k3", imageW: 660, imageH: 560, from: { x: 60, y: 50, w: 540, h: 458 }, to: { x: 0, y: 0, w: 660, h: 560 }, zoomAt: 8 } }, // "130 million output tokens" (7617-7673)
    ...
    // full-anim: the reveal montage OPENS the short (animHook) + the token rain
    fullscreen: [{ from: 108, to: 190 }, { from: 530, to: 700 }],
    outro: "FOLLOW FOR MORE",
    music: "music/tension.MP3",
    style: "paper",
  },
  {
    ...
    beats: [
      // OFFICIAL FILM montage OPENS the short, full-screen (scene 1)
      { at: 4, scene: "clip", tint: "#D97757", text: "the reveal", clip: { src: "assets/external/clips/kimi-open-montage.mp4" } }, // "then there's the open-model claim" (8920-8961)
      // EVIDENCE: Moonshot's own availability paragraph
      { at: 230, scene: "receipt", tint: "#6E93BD", text: "the July-27 line", shot: { src: "assets/external/screenshots/kimi-blog-july27-wide.png", url: "kimi.com/blog/kimi-k3", imageW: 2400, imageH: 1283, from: { x: 400, y: 140, w: 1500, h: 802 }, to: { x: 380, y: 100, w: 1560, h: 834 }, zoomAt: 8, highlight: { x: 435, y: 372, w: 1280, h: 84 }, highlightAt: 60 } }, // "weights are promised for July 27" (9113-9166)
    ...
    // full-anim: the reveal montage OPENS the short (animHook) + the DENIED stamp
    fullscreen: [{ from: 108, to: 190 }, { from: 485, to: 655 }],
    outro: "FOLLOW FOR MORE",
    music: "music/tension.MP3",
    style: "paper",
  },
