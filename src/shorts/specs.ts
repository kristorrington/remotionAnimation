...
export const SHORTS: ShortSpec[] = [
  ...
  },
  {
    ...
    beats: [
      ...
      // EVIDENCE trails the number: the AA verbosity tile
      { at: 210, scene: "receipt", tint: "#C65B52", text: "the 130M tile", shot: { src: "assets/external/screenshots/aa-kimi-tokens.png", url: "artificialanalysis.ai/models/kimi-k3", imageW: 660, imageH: 560, from: { x: 60, y: 50, w: 540, h: 458 }, to: { x: 0, y: 0, w: 660, h: 560 }, zoomAt: 8 } }, // "130 million output tokens" (7617-7673); holds ~7.9s
      { at: 461, scene: "coins", tint: "#C9913D", text: "2× THE MEDIAN" }, // "more than twice the median" (7832-7897); span.from+13
      { at: 700, scene: "stack", tint: "#C65B52", text: "THE BILL STACKS UP" }, // "for a coding agent running for an hour" (8209-8257)
    ],
    // full-anim: the token rain
    fullscreen: [{ from: 448, to: 640 }],
    outro: "FOLLOW FOR MORE",
    music: "music/tension.MP3",
    style: "paper",
  },
  {
    ...
    // full-anim: the DENIED stamp
    fullscreen: [{ from: 480, to: 670 }],
    outro: "FOLLOW FOR MORE",
    music: "music/tension.MP3",
    style: "paper",
  },
