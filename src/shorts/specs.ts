...
export const SHORTS: ShortSpec[] = [
  ...
  // ==========================================================================
  {
    ...
    beats: [
      ...
      { at: 260, scene: "receipt", tint: "#4FA98A", text: "the arena table", shot: { src: "assets/external/screenshots/arena-webdev-top-wide.png", url: "arena.ai/leaderboard/code/webdev", imageW: 2820, imageH: 1507, from: { x: 40, y: 380, w: 2740, h: 1096 }, to: { x: 40, y: 300, w: 2740, h: 800 }, zoomAt: 8, highlight: { x: 46, y: 494, w: 2720, h: 108 }, highlightAt: 80 } }, // "number one spot in front-end coding" (194-282)
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 260, scene: "receipt", tint: "#4FA98A", text: "the vals card", shot: { src: "assets/external/screenshots/vals-kimi-card-wide.png", url: "vals.ai", imageW: 2900, imageH: 1550, from: { x: 100, y: 100, w: 1400, h: 748 }, to: { x: 40, y: 40, w: 2820, h: 1507 }, zoomAt: 8, highlight: { x: 120, y: 300, w: 760, h: 180 }, highlightAt: 120 } }, // "scored 74.7%, placing second of 38" (1244-1452)
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 260, scene: "receipt", tint: "#C65B52", text: "the 130M tile", shot: { src: "assets/external/screenshots/aa-kimi-tokens.png", url: "artificialanalysis.ai/models/kimi-k3", imageW: 660, imageH: 560, from: { x: 60, y: 50, w: 540, h: 458 }, to: { x: 0, y: 0, w: 660, h: 560 }, zoomAt: 8 } }, // "130 million output tokens" (7617-7673)
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 260, scene: "receipt", tint: "#6E93BD", text: "the July-27 line", shot: { src: "assets/external/screenshots/kimi-blog-july27-wide.png", url: "kimi.com/blog/kimi-k3", imageW: 2400, imageH: 1283, from: { x: 400, y: 140, w: 1500, h: 802 }, to: { x: 380, y: 100, w: 1560, h: 834 }, zoomAt: 8, highlight: { x: 435, y: 372, w: 1280, h: 84 }, highlightAt: 60 } }, // "weights are promised for July 27" (9113-9166)
